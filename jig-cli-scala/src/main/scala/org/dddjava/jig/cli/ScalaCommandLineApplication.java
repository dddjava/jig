...
public class ScalaCommandLineApplication implements CommandLineRunner {

    private static final Logger LOGGER = LoggerFactory.getLogger(ScalaCommandLineApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(ScalaCommandLineApplication.class, args);
    }

    @Autowired
    ScalaCliConfig cliConfig;
