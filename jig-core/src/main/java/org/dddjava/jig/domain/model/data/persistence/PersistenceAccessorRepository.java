...
public record PersistenceAccessorRepository(Collection<PersistenceAccessor> values) {
    ...
    public static PersistenceAccessorRepository empty() {
        return new PersistenceAccessorRepository(List.of());
    }

    public static PersistenceAccessorRepository from(Collection<PersistenceAccessor> statements) {
        return new PersistenceAccessorRepository(List.copyOf(statements));
    }

    public PersistenceAccessorRepository merging(Collection<PersistenceAccessor> others) {
        var combined = new ArrayList<>(values);
        combined.addAll(others);
        return new PersistenceAccessorRepository(List.copyOf(combined));
    }
