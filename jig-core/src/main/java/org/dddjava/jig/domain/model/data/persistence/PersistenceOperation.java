 ...
 * クエリはわかる場合のみ持つ。
 */
public record PersistenceOperation(PersistenceOperationId persistenceOperationId, Query query, SqlType sqlType, Tables tables) {
    ...
    public static PersistenceOperation from(PersistenceOperationId statementId, SqlType sqlType, Tables tables) {
