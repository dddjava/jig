/*
 * domain.html 用スクリプト。ファイルが大きいため以下の 4 セクションに区切っている。
 *   1. パッケージ・型データの構築 / 関連の集計（純粋関数中心）
 *   2. Mermaid ダイアグラムソース生成
 *   3. DOM レンダリング（サイドバー、カード、ダイアグラムパネル等）
 *   4. 表示設定とイベント / 初期化
 * セクション区切りは「// ===== セクション N: ... =====」のコメントで明示する。
 */
const DomainApp = (() => {
    ...
    // =================================================================
    // セクション 1: パッケージ・型データの構築 / 関連の集計（純粋関数中心）
    // =================================================================
    ...
    // =================================================================
    // セクション 2: Mermaid ダイアグラムソース生成
    //   - 型/パッケージごとの関連図の組み立て
    //   - 副次的に DOM 要素を返す createRelatedClassesList も近接配置
    // =================================================================
    ...
    // =================================================================
    // セクション 4: 表示設定とイベント / 初期化
    //   - チェックボックス連動の表示切り替え、テキストフィルタ、init
    // =================================================================
