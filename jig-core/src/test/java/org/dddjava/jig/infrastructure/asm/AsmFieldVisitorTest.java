...
import org.dddjava.jig.infrastructure.asm.sut.field.MyEnumFieldSut;
import org.dddjava.jig.infrastructure.asm.sut.field.MyInnerClassGenericsSut;
import org.dddjava.jig.infrastructure.asm.sut.field.MySutClass;
...
class AsmFieldVisitorTest {
    ...
    void フィールドに付与されているアノテーションと記述が取得できる() {
        ...
        assertEquals(TestSupport.getTypeIdFromClass(VariableAnnotation.class), sut.id());
