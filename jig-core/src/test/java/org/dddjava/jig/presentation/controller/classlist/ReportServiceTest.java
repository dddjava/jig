...
class ReportServiceTest {
    ...
    void stubパッケージを対象に各レポートの出力を検証する() throws Exception {
        ...
        assertThat(sut.serviceReport(projectData).rows())
                ...
                .containsExactly(
                        "[stub.application.service.CanonicalService, サービス和名, fuga(FugaIdentifier), Fuga, , , 普通のドメインモデル, [普通の識別子], [FugaRepository, HogeRepository], [HogeRepository.method(), FugaRepository.get(FugaIdentifier)]]",
