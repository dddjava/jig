...
@Repository
public class SpringDataJdbcCrudDelegatingOutbohndAdapter implements SpringDataJdbcCrudDelegatingOutboundPort {
    private final SpringDataJdbcNameRepository repository;

    public SpringDataJdbcCrudDelegatingOutbohndAdapter(SpringDataJdbcNameRepository repository) {
